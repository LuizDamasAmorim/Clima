document.querySelector('#procurar').addEventListener('submit', async (event) => {
    ...
    const apiKey = '6d8a2d1ec0166613c9975191168ad110'
    ...
    if (json.cod === 200) {
        ...
        document.querySelector('#clima').classList.remove('show')
        showAlert( `Não foi possível localizar! <img src="src/img/404.svg">`)
    }
});
